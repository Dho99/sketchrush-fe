...
export function PlayingHistoryPage() {
    ...
    useEffect(() => {
        async function fetchRecords() {
            try {
                const response = await apiRequest<{ data: PlayRecord[] }>(
                    "/api/users/me/play-records",
                );
                ...
                <Card className="border-2 border-dashed border-stone-200 dark:border-stone-800 bg-transparent">
                    <CardContent className="py-16 text-center">
                        ...
                        <p className="text-stone-500 dark:text-stone-400 mb-6">
                            Your match history will appear here once you finish
                            a game while logged in.
                        </p>
                        <a
                            href="/join"
                                    ...
                                    <div
                                        className={cn(
                                            ...
                                            record.win
                                                ...
                                                : "bg-stone-50 dark:bg-stone-900 text-stone-500",
                                        )}
                                    >
                                        {record.win ? (
